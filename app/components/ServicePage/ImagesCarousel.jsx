    ...
    return (
        <div className="w-full h-[72vh] relative -z-5">
            ...
            <div className="flex justify-between w-full absolute top-[33vh]">
                <ChevronLeftIcon className="w-7 h-7 backdrop-blur-2xl text-amber-400 cursor-pointer" onClick={ onPrev }/>
                <ChevronRightIcon className="w-7 h-7 backdrop-blur-2xl text-amber-400 cursor-pointer" onClick={ onNext }/>
            </div>
        </div>
    );
}